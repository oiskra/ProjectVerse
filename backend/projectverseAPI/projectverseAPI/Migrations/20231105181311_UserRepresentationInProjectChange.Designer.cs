...
namespace projectverseAPI.Migrations
{
    ...
    [Migration("20231105181311_UserRepresentationInProjectChange")]
    partial class UserRepresentationInProjectChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projectverseAPI.Models.CollaborationApplicant", b =>
                {
                    ...
                    b.Property<string>("ApplicantUserId1")
                        .HasColumnType("nvarchar(450)");

                    b.Property<Guid>("AppliedCollaborationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ApplicantUserId1");

                    b.HasIndex("AppliedCollaborationId");
            ...
            modelBuilder.Entity("projectverseAPI.Models.CollaborationApplicant", b =>
                {
                    b.HasOne("projectverseAPI.Models.User", "ApplicantUser")
                        .WithMany()
                        .HasForeignKey("ApplicantUserId1");
                    ...
                    b.Navigation("AppliedCollaboration");
            ...
            modelBuilder.Entity("projectverseAPI.Models.Collaboration", b =>
                {
                    b.Navigation("CollaborationApplicants");
